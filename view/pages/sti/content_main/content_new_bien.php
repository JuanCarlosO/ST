    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Complete el formulario para guardar un bien nuevo.</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="alert alert-success alert-dismissible hidden" id="alert_success4">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-check"></i> Éxito </h4>
                El bien a sido almacenado de manera exitosa.
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="alert alert-danger alert-dismissible hidden" id="alert_error4">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-times"></i> Error </h4>
                Ocurrio un error al guardar el bien. Presione F5 e intentelo de nuevo. Si el problema persiste Contacte a Desarrollo de Sistemas.
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div id="alert_success" class="callout callout-success hidden">
                <h4>Registro guardado</h4>

                <p>El nuevo bien a sido registrado de manera exitosa.Puede consultarlo en </p>
              </div>
            </div>
          </div>
